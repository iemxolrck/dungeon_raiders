modifier_wizard_charge_blast_thinker = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_wizard_charge_blast_thinker:IsHidden()
	return true
end

function modifier_wizard_charge_blast_thinker:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_wizard_charge_blast_thinker:OnCreated( kv )
	if IsServer() then
...
function modifier_wizard_charge_blast_thinker:OnDestroy( kv )
	if IsServer() then
		-- find caught units
...
function modifier_wizard_charge_blast_thinker:PlayEffects1()
	-- Get Resources
	local particle_cast = "particles/units/heroes/hero_invoker/invoker_emp.vpcf"
	local sound_cast = "Hero_Invoker.EMP.Charge"

	-- Create Particle
	self.effect_cast = ParticleManager:CreateParticle( particle_cast, PATTACH_POINT, self:GetCaster() )
...
function modifier_wizard_charge_blast_thinker:PlayEffects2()
	-- Get Resources
