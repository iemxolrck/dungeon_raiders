marksman_triple_shot = class({})

LinkLuaModifier( "modifier_marksman_triple_shot", "lua_abilities/marksman_triple_shot/modifier_marksman_triple_shot", LUA_MODIFIER_MOTION_NONE )

function marksman_triple_shot:OnSpellStart()
	...
	if caster:HasAbility( "marksman_dash" )==true then
		self:GetCaster():FindAbilityByName( "marksman_dash" ):CastAbility()
	end
	if caster:HasAbility( "marksman_triple_shot_first_arrow" )==true then
		self:GetCaster():FindAbilityByName( "marksman_triple_shot_first_arrow" ):CastAbility()
	end
	if caster:HasAbility( "marksman_triple_shot_third_arrow" )==true then
		self:GetCaster():FindAbilityByName( "marksman_triple_shot_third_arrow" ):CastAbility()
	end

	caster:AddNewModifier(
		caster,
		self,
		"modifier_marksman_triple_shot",
		{ }
	)

end

function marksman_triple_shot:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
