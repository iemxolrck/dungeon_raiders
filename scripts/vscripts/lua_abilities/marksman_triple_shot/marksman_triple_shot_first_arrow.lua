marksman_triple_shot_first_arrow = class({})

function marksman_triple_shot_first_arrow:OnSpellStart()
...
function marksman_triple_shot_first_arrow:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
