marksman_multishot_fifth_arrow = class({})

function marksman_multishot_fifth_arrow:OnSpellStart()
...
function marksman_multishot_fifth_arrow:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
