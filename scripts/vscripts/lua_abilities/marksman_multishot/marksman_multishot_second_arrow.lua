marksman_multishot_second_arrow = class({})

function marksman_multishot_second_arrow:OnSpellStart()
	...
	projectile_direction = RotatePosition( Vector(0,0,0), QAngle( 0, -15, 0 ), direction )
...
function marksman_multishot_second_arrow:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
