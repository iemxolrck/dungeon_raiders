marksman_multishot_forth_arrow = class({})

function marksman_multishot_forth_arrow:OnSpellStart()
...
function marksman_multishot_forth_arrow:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
