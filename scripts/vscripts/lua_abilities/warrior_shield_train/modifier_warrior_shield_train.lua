modifier_warrior_shield_train = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_warrior_shield_train:IsHidden()
	return false
end

function modifier_warrior_shield_train:IsDebuff()
	return false
end

function modifier_warrior_shield_train:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_warrior_shield_train:OnCreated( kv )
	-- references
...
function modifier_warrior_shield_train:OnRefresh( kv )	
end

function modifier_warrior_shield_train:OnDestroy( kv )
	if IsServer() then
		self:GetParent():InterruptMotionControllers( true )
	end
end

function modifier_warrior_shield_train:OnRemoved( kv )
	if IsServer() then
		-- effects
...
function modifier_warrior_shield_train:DeclareFunctions()
	local funcs = {
...
function modifier_warrior_shield_train:GetOverrideAnimation()
	return ACT_DOTA_RUN
end

--------------------------------------------------------------------------------
-- Status Effects
function modifier_warrior_shield_train:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_warrior_shield_train:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Motion Effects
function modifier_warrior_shield_train:UpdateHorizontalMotion( me, dt )
...
function modifier_warrior_shield_train:OnHorizontalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end

function modifier_warrior_shield_train:End( vector )
	self.pre_collide = vector
	self:Destroy()
end
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_warrior_shield_train:PlayEffects()
	-- Get Resources
