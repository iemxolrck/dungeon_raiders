modifier_marksman_dash = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_marksman_dash:IsHidden()
	return false
end

function modifier_marksman_dash:IsDebuff()
	return false
end

function modifier_marksman_dash:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_marksman_dash:OnCreated( kv )
	-- references
...
function modifier_marksman_dash:OnRefresh( kv )	
end

function modifier_marksman_dash:OnDestroy( kv )
	if IsServer() then
		self:GetParent():InterruptMotionControllers( true )
	end
end

function modifier_marksman_dash:OnRemoved( kv )
	if IsServer() then
		-- effects
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_marksman_dash:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_marksman_dash:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Motion Effects
function modifier_marksman_dash:UpdateHorizontalMotion( me, dt )
...
function modifier_marksman_dash:OnHorizontalMotionInterrupted()
	if IsServer() then
		self:Destroy()
	end
end

function modifier_marksman_dash:End( vector )
	self.pre_collide = vector
	self:Destroy()
end
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_marksman_dash:PlayEffects()
	-- Get Resources
