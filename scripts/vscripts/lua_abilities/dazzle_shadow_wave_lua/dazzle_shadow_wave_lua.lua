...
function dazzle_shadow_wave_lua:OnSpellStart()
	...
	local ability = caster:FindAbilityByName("druid_summon_treant") or caster:FindAbilityByName("druid_summon_golem")
	...
	-- Jump
	self:Jump( jumps, caster, target, ability )
...
function dazzle_shadow_wave_lua:Jump( jumps, source, target, ability )
	-- Heal
	source:Heal( self.damage, source )
	--[[if ability~=nil then
