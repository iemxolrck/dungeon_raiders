engineer_laser_beam = class({})
LinkLuaModifier( "modifier_engineer_laser_beam", "lua_abilities/engineer_laser_beam/modifier_engineer_laser_beam", LUA_MODIFIER_MOTION_NONE )

function engineer_laser_beam:OnAbilityPhaseStart()
	-- effects
...
function engineer_laser_beam:OnSpellStart()
	-- unit identifier
	...
	for _,enemy in pairs(targets) do
		...
		enemy:AddNewModifier(
			...
			self, -- ability source
			"modifier_engineer_laser_beam", -- modifier name
			{ duration = duration } -- kv
		)
	end

	-- effects
	self:PlayEffects2( targets )
	self:PlayEffects3( targets )
	self:PlayEffects4( targets )
	self:PlayEffects5( targets )
	self:PlayEffects2( targets )
	self:PlayEffects3( targets )
	self:PlayEffects4( targets )
	self:PlayEffects5( targets )
...
function engineer_laser_beam:Refract( targets, jumps )
	-- load data
...
--------------------------------------------------------------------------------
function engineer_laser_beam:PlayEffects( targets )
	-- Get Resources
...
function engineer_laser_beam:PlayEffects2( targets )
	-- Get Resources
	local particle_cast = "particles/items_fx/dagon.vpcf"
	--local particle_cast = "particles/econ/events/ti5/dagon_ti5.vpcf"
	--local particle_cast = "particles/econ/events/ti7/dagon_ti7.vpcf"
	--local particle_cast = "particles/econ/events/ti4/dagon_ti4.vpcf"
	local sound_cast = "Hero_Tinker.Laser"
	local sound_target = "Hero_Tinker.LaserImpact"
...
function engineer_laser_beam:PlayEffects3( targets )
	-- Get Resources
	--local particle_cast = "particles/items_fx/dagon.vpcf"
	local particle_cast = "particles/econ/events/ti5/dagon_ti5.vpcf"
	--local particle_cast = "particles/econ/events/ti7/dagon_ti7.vpcf"
...
function engineer_laser_beam:PlayEffects4( targets )
	-- Get Resources
	--local particle_cast = "particles/items_fx/dagon.vpcf"
	--local particle_cast = "particles/econ/events/ti5/dagon_ti5.vpcf"
	local particle_cast = "particles/econ/events/ti7/dagon_ti7.vpcf"
...
function engineer_laser_beam:PlayEffects5( targets )
	-- Get Resources
	--local particle_cast = "particles/items_fx/dagon.vpcf"
	--local particle_cast = "particles/econ/events/ti5/dagon_ti5.vpcf"
	--local particle_cast = "particles/econ/events/ti7/dagon_ti7.vpcf"
