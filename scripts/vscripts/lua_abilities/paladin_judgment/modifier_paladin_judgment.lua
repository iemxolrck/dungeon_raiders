modifier_paladin_judgment = class({})

function modifier_paladin_judgment:IsHidden()
	return false
end

function modifier_paladin_judgment:IsDebuff()
	return true
end

function modifier_paladin_judgment:IsStunDebuff()
	return false
end

function modifier_paladin_judgment:IsPurgable()
	return true
end

function modifier_paladin_judgment:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_paladin_judgment:OnCreated( kv )
	-- references
	local tick_rate = 2
...
function modifier_paladin_judgment:OnRefresh( kv )
	self:OnCreated( kv )
end

function modifier_paladin_judgment:OnRemoved()
end

function modifier_paladin_judgment:OnDestroy()
end

--------------------------------------------------------------------------------
-- Interval Effects
function modifier_paladin_judgment:OnIntervalThink()
	-- stun
...
function modifier_paladin_judgment:DamageCalculation()
...
function modifier_paladin_judgment:PlayEffects2( origin, target )
