LinkLuaModifier("modifier_tusk_snowball_dummy","lua_abilities/wizard_snowball/wizard_snowball", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_tusk_snowball_guest","lua_abilities/wizard_snowball/wizard_snowball", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_tusk_snowball_auto_launch_controller","lua_abilities/wizard_snowball/wizard_snowball", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_tusk_snowball_target_vision","lua_abilities/wizard_snowball/wizard_snowball", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_tusk_snowball_host","lua_abilities/wizard_snowball/wizard_snowball", LUA_MODIFIER_MOTION_NONE )

---@class wizard_snowball : CDOTA_Ability_Lua
wizard_snowball = class({})
---@override
function wizard_snowball:OnUpgrade()
    self:GetCaster():FindAbilityByName(self:GetAssociatedPrimaryAbilities()):SetLevel(self:GetLevel())
end

---@override
function wizard_snowball:GetAssociatedPrimaryAbilities()
    return "wizard_snowball_release"
end

---@override
function wizard_snowball:OnSpellStart()
    ...
    caster:SwapAbilities("wizard_snowball","wizard_snowball_release",false,true)
...
function wizard_snowball:ReleaseSnowball()
    local caster = self:GetCaster()
...
---@override
function wizard_snowball:OnProjectileThink(vLocation)
    local caster = self:GetCaster()
...
---@override
function wizard_snowball:OnProjectileHit(hTarget,vLocation)
    -- Resolve collisions
...
---@class wizard_snowball_release : CDOTA_Ability_Lua
wizard_snowball_release = class({})
---@override
function wizard_snowball_release:GetAssociatedPrimaryAbilities()
    return "wizard_snowball"
end
---@override
function wizard_snowball_release:OnSpellStart()
    local caster = self:GetCaster()
    caster:RemoveModifierByName("modifier_tusk_snowball_auto_launch_controller")
    caster:FindAbilityByName("wizard_snowball"):ReleaseSnowball()
end
...
function modifier_tusk_snowball_auto_launch_controller:OnDestroy()
    if IsServer() then
        self:GetCaster():SwapAbilities("wizard_snowball","wizard_snowball_release",true,false)
        self:GetCaster():FindAbilityByName("wizard_snowball_release"):OnSpellStart()
    end
end
