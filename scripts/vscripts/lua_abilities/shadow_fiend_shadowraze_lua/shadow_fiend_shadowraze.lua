...
LinkLuaModifier( "modifier_shadow_fiend_shadowraze", "lua_abilities/shadow_fiend_shadowraze/modifier_shadow_fiend_shadowraze", LUA_MODIFIER_MOTION_NONE )

function shadow_fiend_shadowraze:GetIntrinsicModifierName()
	return "modifier_shadow_fiend_shadowraze"
end 
