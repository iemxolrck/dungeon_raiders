...
LinkLuaModifier( "modifier_bard_confuse_debuff", "lua_abilities/bard_bewilder/modifier_bard_confuse_debuff", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_bard_bewilder_debuff", "lua_abilities/bard_bewilder/modifier_bard_bewilder_debuff", LUA_MODIFIER_MOTION_NONE )

function bard_bewilder:OnSpellStart()
	-- unit identifier
		...
		if enemy:HasModifier("modifier_bard_lullaby_lua_debuff")==false
			...
			and enemy:HasModifier("modifier_bard_drowzy_debuff")==false  then
				enemy:AddNewModifier(
					...
					self, -- ability source
					"modifier_bard_bewilder_debuff", -- modifier name
...
--------------------------------------------------------------------------------
function bard_bewilder:PlayEffects()
	-- Get Resources
