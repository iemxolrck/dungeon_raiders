modifier_generic_airborne = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_generic_airborne:IsHidden()
	return true
end

function modifier_generic_airborne:IsPurgable()
	return false
end

function modifier_generic_airborne:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_generic_airborne:OnCreated( kv )
	if IsServer() then
...
function modifier_generic_airborne:OnRefresh( kv )
	if not IsServer() then return end
end

function modifier_generic_airborne:OnDestroy( kv )
	if not IsServer() then return end
	self.damageTable = {
...
--------------------------------------------------------------------------------
-- Setter
function modifier_generic_airborne:SetEndCallback( func ) 
	self.EndCallback = func
end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_generic_airborne:DeclareFunctions()
	local funcs = {
...
function modifier_generic_airborne:GetOverrideAnimation( params )
	if self.anim==1 then
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_generic_airborne:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_generic_airborne:UpdateHorizontalMotion( me, dt )
...
function modifier_generic_airborne:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function modifier_generic_airborne:UpdateVerticalMotion( me, dt )
	-- set time
...
function modifier_generic_airborne:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:Destroy()
	end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_generic_airborne:GetEffectName()
	if not IsServer() then return end
	if self.stun then
...
function modifier_generic_airborne:GetEffectAttachType()
	if not IsServer() then return end
